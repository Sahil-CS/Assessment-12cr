...
tk.Button(btn_frame, text="Start", font=normal_font, width=button_width,
...
tk.Button(quiz_frame, text="Submit Answer", font=normal_font, width=button_width,
          bg="blue", fg="#ccf2cc", command=check).pack(pady=5)
tk.Button(quiz_frame, text="Back", font=normal_font, width=button_width,
          bg="orange", fg="black", command=go_back).pack(pady=5)
